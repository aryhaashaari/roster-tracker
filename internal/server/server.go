...
import (
	...
	"gitlab.privy.id/privypass/privypass-boilerplate/internal/router"
...
func (h *httpServer) Run(ctx context.Context) error {
	...
	corsOptions := cors.New(cors.Options{
		AllowedOrigins:   []string{"http://localhost:8081"}, // Update with your allowed origins
	...
	server := http.Server{
		...
		Handler:      corsOptions.Handler(h.router.Route()),
