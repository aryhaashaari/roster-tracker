...
import (
	...
	"gitlab.privy.id/privypass/privypass-boilerplate/cmd/genx"
	"gitlab.privy.id/privypass/privypass-boilerplate/cmd/http"
	"gitlab.privy.id/privypass/privypass-boilerplate/cmd/migration"
